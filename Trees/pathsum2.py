...
class Solution:
    def pathSum(self, root: Optional[TreeNode], targetSum: int) -> List[List[int]]:
        ...
        def dfs(root, targetSum, current_list):
            nonlocal final_list
            if root == None:
                return 
            ...
            if root.left == None and root.right == None:
                ...
                # popping, to bring it to original state.
                current_list.pop()
                return
            ...
            dfs(root.left, targetSum, current_list)
            dfs(root.right, targetSum, current_list)
            # again popping, to bring it to original state.
            current_list.pop()
            return 
